...
## 🚀 Projects & Interests
- 🔐 **[password-toolkit](https://github.com/LucasDelPrete/password-toolkit-java)**  
  A cybersecurity-focused project exploring password generation, strength evaluation, and security practices.  

- Interested in:  
  - Automating system tasks and infrastructure  
  - Exploring cybersecurity challenges  
  - Contributing to open-source tooling, systems administration, and secure software initiatives  
